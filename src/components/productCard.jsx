...
<div className="border-1  bg-slate-100  w-[252px] h-60   ">
        <div className="discount relative top-2  bg-red-500 w-14 h-6 rounded flex items-center text-xs justify-center text-white">
      ...
      <div className="relative left-52 bottom-40  " ><FaRegHeart />
      </div>
      <div className=" relative left-52 bottom-36 "><FaRegEye /></div>
